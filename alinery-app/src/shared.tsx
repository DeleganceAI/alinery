...
// Re-exported so the many existing `from "../shared"` call sites keep working; the
// implementation moved to a React-free module the canvas paint path can import too.
export { formatAbsolute, formatAge };
